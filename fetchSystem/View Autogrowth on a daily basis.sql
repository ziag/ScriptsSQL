...
SET @DL = 'test@mymail.com' -- Change these to the recipients you wish to get the email separated by a semi-colon
  ...
  SET @ReportHTML =
   ...
   CAST(SERVERPROPERTY('MachineName') AS NVARCHAR(128)) + 
    ...
    EXEC msdb.dbo.sp_send_dbmail @recipients=@DL,
           ...
           @body = @ReportHTML,
           @body_format = 'HTML',
           @profile_name='SendMail' ; -- Change this to your profile name
