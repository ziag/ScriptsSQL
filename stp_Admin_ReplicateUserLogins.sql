...
CREATE Procedure [dbo].[stp_Admin_ReplicateUserLogins] --'OriginalSourceDatabase', 1
    @PartnerServer sysname,
    @Debug bit = 1 -- 0 = Create Users, 1 = Display SQL command but doesn't execute query.
AS
/*
EXECUTE TEMP_SIMON_C2.[dbo].[stp_Admin_ReplicateUserLogins] 'TELUS', 1
*/
